...
const data = [
  {
    id: 1,
    question: "20+6=?nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn",
    options: ["26", "20", "24", "28"],
    correctAnswer: "26",
  },
  {
        ...
        <nav className="flex items-center justify-between w-[100%]  px-10 py-0">
          <div className="flex gap-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-base md:text-2xl font-semibold  py-2  text-[#B3CCC2] rounded-md ">
