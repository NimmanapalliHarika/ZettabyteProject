  ...
  return (
    <div className="flex flex-col flex-1 h-screen bg-gray-100 dark:bg-gray-800">
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-0 bg-[#040404] min-h-screen flex flex-col items-center py-4 space-y-2 px-10 md:px-20 lg:px-20 md:w-1/5">
          <div className="flex flex-col items-center">
            <img
              className="object-cover h-20 md:h-40 rounded-full cursor-pointer w-20 md:w-40 lg:w-50"
              src={Logo}
              alt=""
              ref={logoRef}
            />
            ...
            >
              ...
              >
                ...
                <span className="text-[#A8ABBA]  hover:text-[#ECF0F1] sm:hidden md:block">
                  Home
                </span>
              </a>
              <a
        ...
        <main className="flex-1 p-6 overflow-auto bg-[#F3F4F6] text-[#040404]">
          ...
          <header className="flex items-center h-16 mb-8 dark:bg-gray-900">
            <nav className="flex items-center justify-between w-full px-2 py-5 bg-white">
              <div className="flex items-center space-x-4">
                <span className="text-xl font-semibold px-38 py-2 bg-[#040404] text-[#A8ABBA] rounded-md ">
                  Student Dashboard
                </span>
              </div>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Avatar className="sm:h-4 md:h-9 sm:w-4 md:w-9">
                    <AvatarImage
                      alt="User avatar"
          ...
          <section className="mb-8" id="completedcourses">
            ...
            <Swiper
              ...
              navigation={true}
              modules={[Navigation]}
              className="px-3 py-3 mySwiper grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3"
              slidesPerView={[1,2,3]}
              spaceBetween={30}
              ref={classroomRef}
            >
              {classes.map((subject) => (
                <SwiperSlide className=" rounded-[50px]" key={subject.id}>
                  <Card className="py-4 w-auto bg-[#fff] shadow-lg rounded-[30px]">
                    <CardHeader>
          ...
          <div className="flex sm:flex-col flex-row gap-7" ref={leaderboardRef}>
