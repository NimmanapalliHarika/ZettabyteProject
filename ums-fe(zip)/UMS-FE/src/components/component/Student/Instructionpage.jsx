    ...
    <main className="flex flex-col h-screen  bg-[#040404] text-[#A8ABBA] relative justify-center items-center">
      <div className="flex flex-col h-[700px] justify-center relative">
        <header className="w-full mb-10">
          <h1 className="text-2xl md:text-4xl lg:text-6xl font-bold text-[#fff] w-full hover:w-full pl-12">
            Assessment Instructions
          </h1>
        </header>
        <ol className="px-10 py-2 space-y-2 text-base md:text-xl lg:text-2xl leading-7 list-decimal list-inside w-full hover:w-full text-[#A8ABBA]">
        ...
        <div className="flex items-center justify-between w-full mt-10 space-x-30">
          <Link to="/studentui">
            <button
