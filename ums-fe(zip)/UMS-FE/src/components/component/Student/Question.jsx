...
const data = [
  {
    id: 1,
    question: "20+6?nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn",
    options: ["26", "20", "25", "24"],
    correctAnswer: "26",
  },
  {
      ...
      <div className="w-[100%] flex flex-col justify-start items-center">
          ...
          <nav className="flex items-center justify-between w-[100%]  px-10 py-0">
            <div className="flex gap-4" ref={imgRef}>
              <div className=" h-[100px] w-[100px] flex items-center justify-center relative overflow-hidden">
                <Link to="/studentui">
                  <img
                    className="object-cover cursor-pointer h-6 w-6"
                    src={Logo}
                    alt=""
                  />
                </Link>
              ...
              <div className="flex items-center space-x-4 ">
                ...
                <span className="text-lg md:text-xl font-semibold  py-2  text-[#B3CCC2] rounded-md ">
                  PRACTICE
                </span>
                <span className="text-lg md:text-xl font-semibold  py-2  text-[#B3CCC2] rounded-md ">
                  : {selectedUnit.name}
        ...
        <div className="w-[95%] p-4 space-y-4 transition-all mt-5">
          ...
          >
            ...
            <p className="mt-4 text-base md:text-lg text-[#040404] dark:text-gray-400">
              {question.question}
            </p>
