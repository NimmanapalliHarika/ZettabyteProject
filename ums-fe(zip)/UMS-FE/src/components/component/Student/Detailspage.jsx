      ...
      <div className="flex flex-col items-center justify-start w-full mt-16">
          ...
          <nav className="flex items-center justify-between w-[100%] p-10">
            <div className="flex gap-4" ref={imgRef}>
              ...
              <div className="flex items-center space-x-4">
                <span className="text-base md:text-xl font-semibold  py-2 bg-[#040404] text-[#B3CCC2] rounded-md ">
                  YOUR CLASSROOM
                </span>
              </div>
            </div>
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between mb-4">
            <h1 className="text-2xl md:text-4xl font-bold">{selectedClass.title}</h1>
          ...
          {selectedClass.units.map((unit) => (
            ...
            >
              <CollapsibleTrigger asChild className="relative">
                <div className="flex items-center justify-between p-4">
                  <div className="flex items-center gap-4">
                    <h2 className="text-base md:text-xl font-semibold ">{unit.name}</h2>
                  </div>
              ...
              <CollapsibleContent>
                <div className="flex flex-col md:flex-row justify-start gap-2 p-4">
                  <Link
